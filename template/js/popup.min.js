...
var is_safari = navigator.userAgent.indexOf("Safari") > -1;
   ...
   if (is_safari) {
       ...
       if (!document.cookie.match(/^(.*;)?\s*fixed\s*=\s*[^;]+(.*)?$/)) {
           ...
           window.location.replace("https://demo.ellipsecloud.com/modules/safari_fix.html");
       }
   }
