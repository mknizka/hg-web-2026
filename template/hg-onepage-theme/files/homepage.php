	...
	<main>
                  ...
                  <a id="bookban" class="booktoday" href="/booking/today/">
                    <div class="row center-md middle-md">
                      <div class="col-md-4 date">
                        ...
                        <div class="day"><?php echo $todayday ?>.</div>
                        <div class="month"><?php echo $todaymonthname[$todaymonth] ?></div>
                      </div>
                      <div class="col-md-4 date">
                        <span class="popis"><?php echo lang('Check-out', 1) ?></span>
                        <div class="day"><?php echo $nextdaysday ?>.</div>
                        <div class="month"><?php echo $nextdaysmonthname[$nextdaysmonth] ?></div>
                      </div>
                      <div class="col-md-4">
	  		...
	  		<div class="row center-md">
	  			<div class="col-md-12">
	  				<div class="moved-down">
	  					<h2><?php echo lang('Aktivity v okolí',1) ?></h2>
	  					<div class="row center-md">
	  						<div class="col-md-6">
	  							<p class="afterh2"><?php echo lang('V okolí nášho apartmánu nájdete',1) ?></p>
	  						</div>
	  					</div>
		  				...
		  				<div id="owl-offers" class="owl-carousel-offers owl-carousel">
			  				  <?php
			  					...
			  					<?php $poc++;  ?>
									<div class="item">
										<a href="<?php echo $v['link']; ?>" class="btn btn-border left-on-white">
											<div class="onepack">
												<div class="image-inner" style="background: url('../img/ilustrations/3_<?php echo $v['id']; ?>.jpg') 50% 50% no-repeat ;background-size: cover;">

												</div>
												<div class="offer-info">
															<h3><?php echo $v['name']; ?></h3>
															<p><?php echo short(strip_tags($v['text']), 250) ?></p>
	  ...
	  <section id="news" class="wrapper-90-0">
	  	<div class="container">
	  		<div class="row center-md">
	  			<div class="col-md-12">
	  				<h2><?php echo lang('Kontaktný formulár', 1) ?></h2>
	  				<div class="line"><span></span><span></span><span></span></div>
      ...
      $poc = 0;
   	  ...
   	  if ($total > 0):
   	  		...
   	  		foreach($banner as $k => $v): ?>
                      <?php $poc++; ?>
                      <div id="popupbanner" class="animated wow fadeInLeft" data-wow-duration="3s">
                        <a href="<?php echo $v['link']; ?>">
                        	<div class="popupcontent row ">
                        		<div class="popupimg col-md-4" style="background:url(/img/ilustrations/4_<?php echo $v['id']; ?>.<?php echo $v['file_type']; ?>) 50% 50% no-repeat;width: 100%;height:100%;display: block;cursor: pointer;background-size: cover;"></div>
                        		<div class="popuptext col-md-8">
