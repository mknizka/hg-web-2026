...
<?php //_pre($content['voucher_item']); ?>
                            <?php foreach($content['voucher_item'] as $k => $v): ?>
                            <div class="col-md-4">
                              <div class="item">
                                <a href="/<?php echo $content['sefprefix']; ?>/<?php echo $v['id']; ?>/<?php echo $v['sef']; ?>/" class="btn btn-border left-on-white">
                                  <div class="onepack">
                                    <div class="image-inner" style="background: url('/img/voucher/<?php echo $v['id']; ?>.jpg') 50% 50% no-repeat ;background-size: cover;">
                                      <div class="price"><span> <?php echo number_format($v['price'],0); ?> <?php echo lang('€ / poukaz',1) ?></span></div>
                                    </div>
