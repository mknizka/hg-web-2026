			  			...
			  			<article>
					  		<div class="container-fluid" id="article-cont">
					  			<div class="row top-md">
					  				<div class="col-md-12">
					  					<h1><?php echo lang('Potvrdenie registrácie', 1); ?></h1>
		  								<div class="line"><span></span><span></span><span></span></div>
						  				<p><?php echo lang('Blahoželáme, Vaša registrácia bola úspešná.',1); ?></p>
						  				<img src="https://media.giphy.com/media/26DNdnA9C8DUKRTd6/giphy.gif" width="150" alt="">
								...
								<a href="/booking/today/" id="sidebook">
									...
									<div class="container">
										<div class="row">
											...
											<div class="day">
												<span>Check-in</span>
												<p><?php echo $tdExp[0]; ?>.</p>
											</div>
											</div>
											<div class="col-md-6">
												<div class="day">
													<span>Check-out</span>
													<p><?php echo $ndExp[0]; ?>.</p>
												</div>
											</div>
