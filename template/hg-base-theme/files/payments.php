					  				...
					  				<div class="col-md-12">
		  								...
		  								<p>
												<?php
													...
													if($content['content_type'] == 'paymentsresponse') {
														pgResponse($_REQUEST);
													} else
													if($content['content_type'] == 'newpayment') {
														echo lang("New payment page info"),"<br><br>";
														echo lang("Doklad číslo:")." ".$content['number']."<br>";
														echo lang("Suma na úhradu:")." ".$content['amount']." ".$CONFIG['currency']."<br>";
														echo "<a href='".$content['paylink']."' id='paybutton'>".lang('Zaplatiť')."</a>";
													}
