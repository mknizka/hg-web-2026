...
<html lang="<? echo sess("lang"); ?>">
  ...
  <title><?php echo $CONFIG['hotel_name'];  ?> - On-board service</title>
  ...
  <link type="text/css" rel="stylesheet" href="/manager/css/onboard-003.css" media="screen">
  ...
  <body<?php $onboard_data = sess('onboard_data'); if($onboard_data['status'] == 'true') { echo " id='logged'"; } else { echo " id='loggin'"; } ?>>
    <div id="boarding"></div>
    <div id="popup">
      <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
            <div id='login_top_logo'>
               <div class="logowrapp">
                 <?
                      if(file_exists('./img/system/logo_light.png') == true) {echo "<div id='boardlogo' style='background:url(/img/system/logo_light.png) 50% 50% no-repeat;background-size:contain'></div>";}
