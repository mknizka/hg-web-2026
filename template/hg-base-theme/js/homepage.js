...
$(window).bind('scroll', function(){
    ...
    // ticker move when scroll, but not for mobile
  var boxes = $('.ticker-imgs');
  var tickerimages = $('.ticker-imgs img').length;
  var tickerwidth = tickerimages*290;
  $('.ticker-imgs').css( 'width', tickerwidth );
  $window = $(window);
  if ($(window).width() > 640) {
...
$(document).scroll(function () {
    ...
    if (y > (1800)) {
        $(".fixed-menu").fadeIn('slow').addClass("fadeInDown").removeClass("fadeOutUp");
    }
    if ((y < (1800)) && $('.fixed-menu').hasClass('fadeInDown')) {
        $(".fixed-menu").addClass("fadeOutUp").removeClass("fadeInDown").fadeOut('fast');
    }
});
...
{
    if($(window).width() > 350)
        $('#mlb2-2880715').css('width', '310px');
    else
        $('#mlb2-2880715').css('width', '240px');
});

$(document).ready(function() {
    var leftHeight = $('.whitebg').height();
    $('.offer-picture').css({'height':leftHeight});
});

$(document).ready(function() {
    var leftWidth = $('.whitebg').width();
    $('.offer-picture').css({'width':leftWidth});
});
