...
<?php if($selected): ?>
<section class="es-intro"><a class="es-back" href="/blog/?tema=problemy">← Všetky riešenia z praxe</a><p class="kicker">ČO ELLIPSE RIEŠI</p><h1><?php echo hg_esc($selected['title']); ?></h1><p class="es-description"><?php echo hg_esc($selected['description']); ?></p><div class="es-roles"><?php foreach($selected['roles'] as $role): ?><span><?php echo hg_esc($role); ?></span><?php endforeach; ?></div></section>
...
<?php else: ?>
<section class="es-intro"><a class="es-back" href="/blog/">← Ellipse Journal</a><p class="kicker">ČO ELLIPSE RIEŠI</p><h1>Situácie, ktoré poznáte.<br>Riešenia, ktoré prepájajú prevádzku.</h1><p class="es-description">Od nočného príchodu cez platby až po riadenie tímu. Vyberte si zo 34 tém z hotelovej a HORECA praxe.</p></section>
