...
<main class="eb-blog">
  <section class="eb-intro">
    ...
    <nav class="eb-tabs" aria-label="<?php echo hg_lang('Sekcie blogu','Blog sections'); ?>"><a href="/blog/"<?php if(!$problemView) echo ' aria-current="page"'; ?>><?php echo hg_lang('Všetky články','All articles'); ?></a><a href="/blog/?tema=problemy"<?php if($problemView) echo ' aria-current="page"'; ?>><?php echo hg_lang('Aké problémy riešime','Challenges we solve'); ?> <span aria-hidden="true"><svg class="hg-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M7 17 17 7M7 7h10v10"/></svg></span></a></nav>
  </section>
  <?php if($problemView): ?>
