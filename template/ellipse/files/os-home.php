...
<section class="em-pos" id="pos" aria-label="Ellipse POS"><p class="os-kicker">Ellipse POS</p><h2><?php echo hg_lang('Od objednávky po zaplatený účet.', 'From the first order to the final payment.'); ?></h2><p class="os-lead"><?php echo hg_lang('Stoly, objednávky aj uzávierky priamo v ruke. Pozrite si skutočné prostredie Ellipse POS — prehľadne a do detailu.', 'Tables, orders and closing reports in your hand. Explore the real Ellipse POS interface in detail.'); ?></p><div class="em-showcase"><div class="em-controls"><span><?php echo hg_lang('Skutočné obrazovky. Každý detail.', 'Real screens. Every detail.'); ?></span><button type="button" data-mobile-prev aria-label="<?php echo hg_lang('Predchádzajúce obrazovky', 'Previous screens'); ?>">←</button><button type="button" data-mobile-next aria-label="<?php echo hg_lang('Ďalšie obrazovky', 'Next screens'); ?>">→</button></div><div class="em-rail" tabindex="0" aria-label="Ellipse POS"><figure class="em-shot"><button class="em-phone" type="button" data-screen-open aria-label="<?php echo hg_lang('Zväčšiť: Prehľad stolov', 'Enlarge: Table overview'); ?>"><img src="<?php echo hg_esc(hg_asset('mobile/screen-10.webp')); ?>" width="885" height="1920" alt="Ellipse POS — <?php echo hg_lang('Prehľad stolov', 'Table overview'); ?>" loading="lazy" decoding="async"></button><figcaption><?php echo hg_lang('Prehľad stolov', 'Table overview'); ?></figcaption></figure><figure class="em-shot"><button class="em-phone" type="button" data-screen-open aria-label="<?php echo hg_lang('Zväčšiť: Objednávka pri stole', 'Enlarge: Ordering at the table'); ?>"><img src="<?php echo hg_esc(hg_asset('mobile/screen-11.webp')); ?>" width="885" height="1920" alt="Ellipse POS — <?php echo hg_lang('Objednávka pri stole', 'Ordering at the table'); ?>" loading="lazy" decoding="async"></button><figcaption><?php echo hg_lang('Objednávka pri stole', 'Ordering at the table'); ?></figcaption></figure><figure class="em-shot"><button class="em-phone" type="button" data-screen-open aria-label="<?php echo hg_lang('Zväčšiť: Tržby a uzávierky', 'Enlarge: Sales and closing reports'); ?>"><img src="<?php echo hg_esc(hg_asset('mobile/screen-09.webp')); ?>" width="885" height="1920" alt="Ellipse POS — <?php echo hg_lang('Tržby a uzávierky', 'Sales and closing reports'); ?>" loading="lazy" decoding="async"></button><figcaption><?php echo hg_lang('Tržby a uzávierky', 'Sales and closing reports'); ?></figcaption></figure></div></div><div class="os-actions"><a class="button ghost" href="/pos-systemy/"><?php echo hg_lang('Objavte Ellipse POS', 'Discover Ellipse POS'); ?></a></div></section>
